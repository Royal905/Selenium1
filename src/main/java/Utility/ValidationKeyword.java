...
//	}
	...
	public void validateSearchBoxError(String textBoxLocator, String errorLocator) {
       ...
       // String allowedCharactersPattern = "^[a-zA-Z0-9_-]+$"; // Alphanumeric (a-z, A-Z, 0-9), underscore (_), hyphen (-)
	...
	public void validateSearchBox(String textBoxLocator, String suggestionLocator) {
		  WebElement inputBox = driver.findElement(getLocator(textBoxLocator));
	      WebElement suggestion = driver.findElement(getLocator(suggestionLocator));
	      String inputText = inputBox.getAttribute("value");
